...
var b=50,c=function(){var a=document.body.scrollTop<b?"nav-visible":"nav-hidden";document.body.className!=a&&(document.body.className=a)};a.onscroll=c,c();var d={};d.controller=function(){this.name="",this.email="",this.message="",this.result=""},d.controller.prototype.capitalize=function(a){return a.toLowerCase().replace(/\b\w/g,function(a){return a.toUpperCase()})},d.view=function(a){return[m("form",{onsubmit:function(b){b.preventDefault(),a.result="","string"!=typeof a.name||a.name.trim()?"string"!=typeof a.email||a.email.trim()?"string"!=typeof a.email||/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/.test(a.email)?"string"!=typeof a.message||a.message.trim()?m.request({url:"/shoot",method:"POST",data:{name:a.name,email:a.email,message:a.message}}).then(function(b){b&&b.success===!0?(a.result="Hey "+a.name+"! I got your email. I will get back to you soon.",a.name="",a.email="",a.message=""):b&&b.success===!1&&b.error&&(a.result=b.error)}):a.result="Haha I thought you are gonna tell me something":a.result="Sorry! It seems like your email address is wrong":a.result="Please enter your email buddy":a.result="Please enter your name buddy"}},[a.result?m("li",[m("div.notification",a.result)]):void 0,m("li.col-2",[m('input.site.site-section.section-contact-input[name="name"][placeholder="Your Name"][type="text"]',{spellcheck:!1,autocomplete:"off",value:a.name,oninput:function(){a.name=a.capitalize(this.value)}})]),m("li.col-2",[m('input.site.site-section.section-contact-input[name="email"][placeholder="Email Address"][type="text"]',{spellcheck:!1,autocomplete:"off",value:a.email,oninput:function(){a.email=this.value}})]),m("li.clear"),m("li",[m('textarea.site.site-section.section-contact-textarea[name="message"][placeholder="Write me something yeah!"]',{spellcheck:!1,autocomplete:"off",oninput:function(){a.message=this.value}},a.message)]),m("li",[m('input.site.site-section.section-contact-button[name="submit"][type="submit"][value="Ready? Shoot!"]')])])]},m.module(document.querySelector("#section-home-contact ul"),d)}(window||this);